...
from mailgunsdk.ips import IPs
...
class IPsTestCase(unittest.TestCase):
    ...
    def test_list(self, request):
        ...
        request.assert_called_with("GET", params={})
    ...
    def test_list_dedicated(self, request):
        ...
        request.assert_called_with("GET", params={"dedicated": "true"})
        self.assertEqual(response, request.return_value)
    ...
    def test_detail(self, request):
        ...
        request.assert_called_with("GET", "111.222.333.444")
        self.assertEqual(response, request.return_value)
